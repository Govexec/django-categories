...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('categories_category', ['order'])

        # Adding index on 'Category', fields ['is_blog']
        db.create_index('categories_category', ['is_blog'])


    def backwards(self, orm):
        
        # Removing index on 'Category', fields ['is_blog']
        db.delete_index('categories_category', ['is_blog'])

        # Removing index on 'Category', fields ['order']
        db.delete_index('categories_category', ['order'])
