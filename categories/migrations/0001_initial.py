    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unicode_name', models.CharField(default=None, max_length=255, blank=True)),
                ...
                ('show_converser_ad', models.BooleanField(default=False, help_text=b'Select to enable a converser ad for the category page. A 600x300 converser ad unit must be active in Dart.', verbose_name=b'Show a converser ad?')),
