...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.show_converser_ad'
        db.add_column('categories_category', 'show_converser_ad', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.show_converser_ad'
        db.delete_column('categories_category', 'show_converser_ad')
